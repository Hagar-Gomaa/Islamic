...
lateinit var suraList :List<String>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        suraList = list
        suraNameAdapter = SuraNameAdapter(suraList)
        binding.recycleSuraname.adapter = suraNameAdapter
        ...
        suraNameAdapter.onItemClickListener = object : SuraNameAdapter.OnItemClickListener {
            override fun onItemClick(pos: Int, item: String) {
                val intent = Intent(activity, SuraDeteails::class.java);
        ...
        val list = listOf("الفاتحه","البقرة","آل عمران","النساء","المائدة","الأنعام","الأعراف","الأنفال","التوبة","يونس","هود"
